...
class AiManager(
    ...
    fun modelFitness(
        ...
        ramGB: Double,
        diskGB: Double,
    ): String = aiModelFitness(handle, modelId, ramGB, diskGB) ?: "{}"
    ...
    private external fun aiModelFitness(
        handle: Long,
        modelId: String,
        ramGB: Double,
        diskGB: Double,
    ...
    private external fun aiIsModelDownloaded(
        handle: Long,
        modelId: String,
    ): Boolean

    private external fun aiModelPath(
        handle: Long,
        modelId: String,
    ): String?

    private external fun aiRemoveModel(
        handle: Long,
        modelId: String,
    ): Boolean

    private external fun aiSetOllamaEndpoint(
        handle: Long,
        endpoint: String,
    )
    ...
    private external fun aiOllamaInfer(
        handle: Long,
        model: String,
        requestJson: String,
    ): String?
